...
#     np.save('times_train' + suffix + '.npy', timestamps_train)
    ...
    loc_test, vel_test, edges_test, timestamps_test = generate_dataset_Pendulum(args, args.num_test, isTrain=False)
    np.save('loc_test' + suffix + '.npy', loc_test)
    np.save('vel_test' + suffix + '.npy', vel_test)
    np.save('edges_test' + suffix + '.npy', edges_test)
    np.save('times_test' + suffix + '.npy', timestamps_test)
    ...
    print("Generating {} training simulations".format(args.num_train))
    loc_train, vel_train, edges_train, timestamps_train =  generate_dataset_Pendulum(args, args.num_train, isTrain=True)
